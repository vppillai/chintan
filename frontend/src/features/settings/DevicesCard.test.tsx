...
import { DevicesCard, MAX_DEVICES, curlRecipe, inboxAudioUrl } from './DevicesCard.tsx';
...
describe('the devices card on You', () => {
  ...
  it('mints a key once: the name is posted, the key is shown with its warning, Done hides it for good', async () => {
    ...
    // Trimmed, and posted under an idempotency key like every other create.
