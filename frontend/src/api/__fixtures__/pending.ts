...
import { captureMoved, noteDetail, usage } from './responses.ts';
...
export const captureFromDeviceText: CaptureWire = {
  ...captureMoved,
  appended_at: '2026-01-01T00:00:03.000000000Z',
  duration_ms: 0,
  has_audio: false,
  has_peaks: false,
  has_segments: false,
  id: 'fixture-capture-text-id',
